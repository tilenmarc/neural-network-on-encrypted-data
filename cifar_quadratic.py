...
img_size_flat = 3 * img_h * img_w + 1 # 28x28 + 1=785, the total number of pixels plus bias
...
def load_data(mode='train'):
    ...
    x_train, y_train, x_valid, y_valid = cifar10[0][0], cifar10[0][1], cifar10[1][0], cifar10[1][1]
...
x2 = tf.keras.layers.Dense(20, kernel_initializer='glorot_normal')(x1)
# x = tf.keras.layers.Dense(20, use_bias=False, kernel_initializer='glorot_normal')(inputs)
multiplied = tf.keras.layers.Multiply()([x2, x2])
# output = tf.keras.layers.Dense(10, use_bias=False, activation=tf.nn.softmax)(x2)
output = tf.keras.layers.Dense(10, kernel_initializer='glorot_normal', use_bias=False)(multiplied)
...
# output = tf.keras.layers.Dense(10, use_bias=False, kernel_initializer='glorot_normal')(x2)
#
#
