...
model = tf.keras.Sequential([
    tf.keras.layers.Dense(10, use_bias=False, activation=tf.nn.softmax, input_shape=(img_size_flat, ))
])
...
Pr_model = weights[0]
Pr = discretize_data(weights[0], disc_value)
Pr = Pr * disc_value
Pr = Pr.astype(int)
print(Pr)
